...
export class ProfileController {
  ...
  @Patch('favoriteFilme/:id')
  @ApiOperation({
    summary: 'Adicionar ou remover um Filme do favorito',
  })
  updateFavorite(
    @Param('id') id: string,
    @Body() UpdateProfileDto: UpdateProfileDto,
  ) {
    return this.profileService.addOrRemoveFavoriteFilme(
      id,
      UpdateProfileDto.favoitefilmeId,
    );
  }
